...
export const AppCard: FC<AppCardProps> = ({ name, description, icon, url }) => (
  <div style={styles.card}>
    ...
    <Text size="small" weight="bold" style={{ textAlign: 'center' }}>{name}</Text>
...
const APPS = [
  {
    ...
    description: 'Boost sales by showing related products that customers often buy together.',
  ...
  },
  {
    ...
    description: 'Validate shipping addresses at checkout to reduce failed deliveries.',
  ...
  },
  {
    ...
    description: 'Display Google Drive files and folders directly on your site.',
        ...
        <Card>
          <Card.Content>
            <Box direction="vertical" gap="18px">
              <Text size="medium" weight="bold">More apps by us</Text>
              ...
              <Box direction="horizontal" verticalAlign="middle" marginTop="6px">
                ...
                <div style={styles.poweredByRow}>
                  ...
                  <img src={brandLogo} alt="Brand" style={styles.poweredByLogo} />
                </div>
              </Box>
            </Box>
          </Card.Content>
