...
| gift-cards | — _(no recipe by design — no seed surface; activation lives in Phase 2 app-install)_                                                                                                                                                                                         | `{status: "skipped"}`                                                               |
| ecom       | — _(no recipe by design — cart/checkout vertical; no seed surface)_                                                                                                                                                                                                          | `{status: "skipped"}`                                                               |
