    ...
    "nodes": [
      {
        ...
        "nodes": [
          {
            "type": "TEXT",
            "textData": { "text": "Welcome", "decorations": [] }
          }
        ]
      },
      {
        ...
        "nodes": [
          {
            "type": "TEXT",
            "textData": { "text": "This is a ", "decorations": [] }
          },
          {
            "type": "TEXT",
            "textData": {
          ...
          {
            "type": "TEXT",
            "textData": { "text": " paragraph with a ", "decorations": [] }
          },
          {
            "type": "TEXT",
            "textData": {
              ...
              "decorations": [
                {
                  "type": "LINK",
                  "linkData": {
                    "link": { "url": "https://example.com", "target": "SELF" }
                  }
                }
              ]
            }
        ...
        "nodes": [
          {
            "type": "TEXT",
            "id": "t2",
            "textData": { "text": "Hello world with ", "decorations": [] }
          },
          {
            "type": "TEXT",
            "id": "t3",
